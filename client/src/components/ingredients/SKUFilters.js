...
import {
  ...
  Form, FormGroup, Label, CustomInput, Col, Button
} from 'reactstrap';
...
class SKUFilters extends React.Component {
  ...
  render() {
    ...
    return (
      <div>SKU Filters:  {'  '}
      <Badge style={{'marginLeft': '2px', 'marginRight': '2px'}} href="#" color="light"
      ...
      <Badge style={{'marginLeft': '2px', 'marginRight': '2px'}} href="#" onClick={this.toggle} color="success">+ Add SKU Filter</Badge>

    ...
    if(loading && !this.state.sku_drilldown_modal){
      ...
      return (
                        ...
                        <Table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{report.find(elem => elem.sku === this.state.curr_sku._id) && parseFloat(report.find(elem => elem.sku === this.state.curr_sku._id).summary.profit_margin * 100).toFixed(2)}%</td>
                                </tr>
                            </tbody>
                        </Table>
                    </div>
        ...
        <Modal isOpen={this.state.sku_drilldown_modal} toggle={this.drilldown_toggle} className="modal-xl">
             ...
             <SKUDrillDownModal all_customers={this.props.all_customers} sel_customer={this.props.sel_customer} curr_sku={this.state.curr_sku}/>
        </Modal>
        </div>
      );
      }

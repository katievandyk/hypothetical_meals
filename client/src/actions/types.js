...
export const AUTOSCHEDULE = 'AUTOSCHEDULE';
export const BULK_ACTIVITIES = 'BULK_ACTIVITIES';
...
export const SALES_GET_SKUS_BY_PL = 'SALES_GET_SKUS_BY_PL'
export const GET_CUSTOMERS = 'GET_CUSTOMERS';
export const EXPORT_SUMMARY = 'EXPORT_SUMMARY';
export const GET_SKU_DRILLDOWN = 'GET_SKU_DRILLDOWN';
export const EXPORT_DRILLDOWN = 'EXPORT_DRILLDOWN';
